...
align_file='/home/mxc/wonderland/ipin_data/01-Training/01a-Regular/T01_01/ACCEGYROMAGN.csv';
path='/home/mxc/wonderland/datasets/IPIN/logfiles2020/Logfiles/processed/01-Training/01a-Regular/';
quaternion_path = '/home/mxc/wonderland/datasets/IPIN/quaternion_6_axis_4.0.csv';

% align_file='/home/mxc/wonderland/ipin_data/01-Training/01a-Regular/T01_01/ACCEGYROMAGNAHRS.csv';


% 
% align_file='/home/mxc/wonderland/datasets/IPIN/cardboard_accgyro.csv';
% path='/home/mxc/wonderland/datasets/IPIN/logfiles2020/Logfiles/processed/01-Training/01a-Regular/';
...
%     scatter(PositionY(k+1),PositionX(k+1)); grid on; % north-up
    ...
    scatter(PositionX(k+1),PositionY(k+1),'r'); grid on; % north-up
    hold on;
      pause(0.01)
end