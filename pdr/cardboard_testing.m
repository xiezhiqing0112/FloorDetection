...
%  trial=csvread(align_file,1,1);
trial=dlmread(align_file);
...
quaternion=dlmread(quaternion_path);
quaternion = quaternion(1:length(quaternion(:,1)),:);
